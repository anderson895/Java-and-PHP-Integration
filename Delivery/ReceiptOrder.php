...
<tr >
	...
	<td width="70%"><center><?php echo $orderdate  ?></td>
</tr>
...
<tr >
	...
	<td width="70%"><center><?php echo $order_id; ?></td>
</tr>
<tr >
...
$order_id = $a; // replace with the desired order ID
$delivery_file = "../IPT/Padilla_FileHandling/Simple Ordering System in Java-20230224T023058Z-001/Simple Ordering System in Java/storage/order.txt";
...
$order_id = $a; // replace with the desired order ID
$delivery_file = "../IPT/Padilla_FileHandling/Simple Ordering System in Java-20230224T023058Z-001\Simple Ordering System in Java\storage/costumerReceived.txt";
...
$filename = "../IPT/Padilla_FileHandling/Simple Ordering System in Java-20230224T023058Z-001/Simple Ordering System in Java/storage/costumerReceived.txt";
...
<table>
<tr>
<td><button  class="submit-btn" onclick="window.location.href = 'paid.php?a=<?php echo $a?>';">PAID</button></td>
<td width='20%'></td>
<td><button class="back-btn" onclick="window.location.href = 'index.php';">BACK</button></td>
